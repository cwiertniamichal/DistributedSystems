...
public abstract class _NightCameraDisp extends Ice.ObjectImpl implements NightCamera
{
    protected void
    ...
    public final void switchNightModeOption()
    {
        switchNightModeOption(null);
    }

    public static Ice.DispatchStatus ___switchNightModeOption(NightCamera __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.readEmptyParams();
        __obj.switchNightModeOption(__current);
    ...
    public Ice.DispatchStatus __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 11:
            {
                return ___switchNightModeOption(this, in, __current);
            }
        }
