...
public abstract class _DeviceDisp extends Ice.ObjectImpl implements Device
{
    ...
    public static Ice.DispatchStatus ___getDeviceFunctions(Device __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.readEmptyParams();
        java.util.List<java.lang.String> __ret = __obj.getDeviceFunctions(__current);
    ...
    public Ice.DispatchStatus __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            case 0:
            {
                return ___getDeviceFunctions(this, in, __current);
            }
            case 1:
            {
